...
@Override
public ISourceElement getSourceElementAt_(int position, IContext context, IProgressMonitor monitor) throws CoreException {
...
public ISourceElementInfo getSourceElementInfo_(IContext context, IProgressMonitor monitor) throws CoreException {
	CompilationUnitElementInfo info = (CompilationUnitElementInfo) getBody_(context, monitor);
...
public void openParent_(IContext context, IProgressMonitor monitor) throws CoreException {
	...
	super.openParent_(context, monitor);
}
/*
