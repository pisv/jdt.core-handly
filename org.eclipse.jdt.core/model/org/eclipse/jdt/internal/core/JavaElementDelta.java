...
public IJavaElementDelta[] getAddedChildren() {
	return toJavaElementDeltas(getAddedChildren_());
}
/**
 * @see IJavaElementDelta
 */
public IJavaElementDelta[] getAffectedChildren() {
	return toJavaElementDeltas(getAffectedChildren_());
}
...
public IJavaElementDelta[] getChangedChildren() {
	return toJavaElementDeltas(getChangedChildren_());
}
...
public IJavaElementDelta[] getRemovedChildren() {
	return toJavaElementDeltas(getRemovedChildren_());
}
/**
...
protected void insertDeltaTree(IJavaElement element, JavaElementDelta delta) {
	if (!Elements.equalsAndSameParent(getElement_(), delta.getElement_()))
