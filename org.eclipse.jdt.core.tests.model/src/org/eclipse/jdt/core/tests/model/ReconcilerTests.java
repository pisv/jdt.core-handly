...
public void testMethodWithError07() throws CoreException {
	...
	try {
		...
		// Close working copy
		((CompilationUnit)this.workingCopy).remove_(EMPTY_CONTEXT); // use a back door as working copies cannot be closed
...
public void testMoveMember() throws JavaModelException {
	...
	assertWorkingCopyDeltas(
		"Unexpected delta",
		"X[*]: {CHILDREN | FINE GRAINED}\n" +
		"	bar()[*]: {REORDERED | FINE GRAINED}\n" +
		"	foo()[*]: {REORDERED | FINE GRAINED}"
	);
}
/**
